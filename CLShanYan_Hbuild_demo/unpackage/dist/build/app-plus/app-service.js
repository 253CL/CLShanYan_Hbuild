...
(global["webpackJsonp"]=global["webpackJsonp"]||[]).push([["pages/login/login"],{"159f":function(t,o,e){"use strict";(function(t){e("48a7"),e("921b");n(e("66fd"));var o=n(e("8e25"));function n(t){return t&&t.__esModule?t:{default:t}}t(o.default)}).call(this,e("6e42")["createPage"])},"2b43":function(t,o,e){},"66c0":function(t,o,e){"use strict";(function(t,n){Object.defineProperty(o,"__esModule",{value:!0}),o.default=void 0;a(e("c3c8"));var i=e("2f62");function a(t){return t&&t.__esModule?t:{default:t}}var c=function(){return e.e("components/m-input").then(e.bind(null,"d49f"))},l=t.requireNativePlugin("CLSDK-ShanYanSDKModule"),g={onLoad:function(t){},components:{mInput:c},data:function(){return{account:"",shanyan_code:"状态码",shanyan_result:"信息描述",ios_uiConfigure:{}}},computed:(0,i.mapState)(["forcedLogin"]),methods:{init:function(){var o=this;t.showLoading({mask:!0});var e,i=t.getSystemInfoSync().platform;"android"==i?e="loXN4jDs":"ios"==i&&(e="eWWfA2KJ"),l.init({appid:e},function(e){t.hideLoading(),o.shanyan_code=JSON.stringify(e.code),o.shanyan_result=JSON.stringify(e),console.log(n(JSON.stringify(e)," at pages/login/login.vue:87"))})},getPhoneInfo:function(){var o=this;t.showLoading({mask:!0});var e=t.getSystemInfoSync().platform;"android"==e?l.getPhoneInfo(function(e){t.hideLoading(),o.shanyan_code=JSON.stringify(e.code),o.shanyan_result=JSON.stringify(e.result),console.log(n(JSON.stringify(e)," at pages/login/login.vue:102"))}):"ios"==e&&l.preGetPhonenumber(function(e){t.hideLoading(),o.shanyan_code=JSON.stringify(e.code),o.shanyan_result=JSON.stringify(e),console.log(n(JSON.stringify(e)," at pages/login/login.vue:110"))})},setAuthCJSThemeConfig:function(){var o=t.getSystemInfoSync().platform;if("android"==o)l.setAuthThemeConfig({uiConfig:{setAuthBGImgPath:"static/eb9a0dae18491990a43fe02832d3cafa.jpg",setNavColor:"#ff0000",setLogoImgPath:"static/logo_shanyan_text.png",setAppPrivacyOne:{title:"闪验用户协议",url:"https://api.253.com/api_doc/yin-si-zheng-ce/wei-hu-wang-luo-an-quan-sheng-ming.html"},setAppPrivacyTwo:{title:"闪验隐私政策",url:"https://api.253.com/api_doc/yin-si-zheng-ce/ge-ren-xin-xi-bao-hu-sheng-ming.html"},setAppPrivacyThree:{title:"服务协议",url:"https://api.253.com/api_doc/yin-si-zheng-ce/ge-ren-xin-xi-bao-hu-sheng-ming.html"},setPrivacyState:!1,setPrivacyText:{privacyTextOne:"登录即同意",privacyTextTwo:"、",privacyTextThree:"、",privacyTextFour:"和",privacyTextFive:"并授权登录"}},widgets:{widget1:{widgetId:"customView_one",type:"TextView",left:"",top:"300",right:"",bottom:"",width:"",height:"30",textContent:"自定义控件1（点击不销毁授权页）",textFont:"13",textColor:"#cc0000",backgroundColor:"#ffffff",isFinish:"false"},widget2:{widgetId:"customView_two",type:"TextView",left:"",top:"360",right:"",bottom:"",width:"",height:"30",textContent:"自定义控件2（点击销毁授权页）",textFont:"13",textColor:"#cc0000",backgroundColor:"#ffffff",isFinish:"true"},widget3:{widgetId:"customView_three",type:"ImageView",left:"",top:"400",right:"",bottom:"",width:"",height:"",backgroundImgPath:"static/qq.png",isFinish:"true"}}},function(t){console.log(n(JSON.stringify(t)," at pages/login/login.vue:194"))}),this.shanyan_code=1e3,this.shanyan_result="授权页配置完成";else if("ios"==o){var e=plus.screen.resolutionWidth,i=(plus.screen.resolutionHeight,plus.screen.resolutionHeight,plus.screen.resolutionWidth,e/375);i>1&&(i=1);var a=60*i,c=60*i,g=60*i,r=0,s=-20*i,u=50*i,h=-50*i,y=20*i,d=s+.5*y*i+20*i+15*i,f=30*i,L=70*i,p=-70*i,m=40*i,v=-40*i,B=0*i,C=45*i,S=0,w=0,P=15*i,A=B-C,x=60*i,_=60*i,O=0,T=25*i,N=-20*i,k=50*i,b=-50*i,I=20*i,J=N+.5*I*i+20*i+15*i,H=30*i,R=70*i,W=-70*i,F=40*i,Y=-40*i,z=0*i,V=45*i,q=0,X=0,j=15*i,D=z-V;this.ios_uiConfigure={clBackgroundImg:"static/eb9a0dae18491990a43fe02832d3cafa.jpg",shouldAutorotate:!0,supportedInterfaceOrientations:5,clNavigationBackgroundClear:!0,clNavigationBackBtnImage:"static/img/close-white.png",clNavBackBtnAlimentRight:!0,clLogoImage:"static/img/logo_shanyan_text.png",clLoginBtnText:"本机号一键登录",clLoginBtnTextColor:[1,1,1,1],clLoginBtnBgColor:[.2,.8,.2,1],clLoginBtnTextFont:15*i,clLoginBtnCornerRadius:10,clLoginBtnBorderWidth:.5,clLoginBtnBorderColor:[.1,.8,.1,1],clPhoneNumberFont:20*i,clAppPrivacyColor:[[.6,.6,.6,1],[0,1,0,1]],clAppPrivacyTextFont:11*i,clAppPrivacyTextAlignment:0,clAppPrivacyFirst:["测试连接A","https://www.baidu.com"],clAppPrivacySecond:["测试连接B","https://www.sina.com"],clCheckBoxVerticalAlignmentToAppPrivacyCenterY:!0,clCheckBoxSize:[30*i,30*i],clCheckBoxImageEdgeInsets:[2*i,10*i,13*i,5*i],clCheckBoxUncheckedImage:"static/img/checkBoxNor.png",clCheckBoxCheckedImage:"static/img/checkBoxSEL.png",clLoadingSize:[50,50],clLoadingTintColor:[.2,.8,.2,1],clLoadingBackgroundColor:[1,1,1,1],clLoadingCornerRadius:5,clOrientationLayOutPortrait:{clLayoutLogoWidth:c,clLayoutLogoHeight:g,clLayoutLogoCenterX:r,clLayoutLogoTop:a,clLayoutPhoneCenterY:s,clLayoutPhoneHeight:y,clLayoutPhoneLeft:u,clLayoutPhoneRight:h,clLayoutLoginBtnCenterY:d,clLayoutLoginBtnHeight:f,clLayoutLoginBtnLeft:L,clLayoutLoginBtnRight:p,clLayoutAppPrivacyLeft:m,clLayoutAppPrivacyRight:v,clLayoutAppPrivacyBottom:B,clLayoutAppPrivacyHeight:C,clLayoutSloganLeft:S,clLayoutSloganRight:w,clLayoutSloganHeight:P,clLayoutSloganBottom:A},clOrientationLayOutLandscape:{clLayoutLogoWidth:x,clLayoutLogoHeight:_,clLayoutLogoCenterX:O,clLayoutLogoTop:T,clLayoutPhoneCenterY:N,clLayoutPhoneHeight:I,clLayoutPhoneLeft:k,clLayoutPhoneRight:b,clLayoutLoginBtnCenterY:J,clLayoutLoginBtnHeight:H,clLayoutLoginBtnLeft:R,clLayoutLoginBtnRight:W,clLayoutAppPrivacyLeft:F,clLayoutAppPrivacyRight:Y,clLayoutAppPrivacyBottom:z,clLayoutAppPrivacyHeight:V,clLayoutSloganLeft:q,clLayoutSloganRight:X,clLayoutSloganHeight:j,clLayoutSloganBottom:D}},this.shanyan_code=1e3,this.shanyan_result="授权页配置完成"}},setAuthDialogThemeConfig:function(){var o=t.getSystemInfoSync().platform;if("android"==o)l.setAuthThemeConfig({uiConfig:{setAuthBGImgPath:"static/eb9a0dae18491990a43fe02832d3cafa.jpg",setNavColor:"#ff0000",setNavText:"",setNavTextSize:"0",setNavReturnImgPath:"static/close_black.png",setNavReturnBtnOffsetRightX:"15",setLogoImgPath:"static/logo_shanyan_text.png",setLogoOffsetY:"15",setLogoWidth:"110",setLogoHeight:"60",setNumFieldOffsetY:"80",setNumberSize:"18",setLogBtnText:"本机号码免密登录",setLogBtnOffsetY:"140",setPrivacyState:"true",setAppPrivacyOne:{title:"闪验用户协议",url:"https://api.253.com/api_doc/yin-si-zheng-ce/wei-hu-wang-luo-an-quan-sheng-ming.html"},setAppPrivacyTwo:{title:"闪验隐私政策",url:"https://api.253.com/api_doc/yin-si-zheng-ce/ge-ren-xin-xi-bao-hu-sheng-ming.html"},setAppPrivacyThree:{title:"服务协议",url:"https://api.253.com/api_doc/yin-si-zheng-ce/ge-ren-xin-xi-bao-hu-sheng-ming.html"},setPrivacyText:{privacyTextOne:"登录即同意",privacyTextTwo:"、",privacyTextThree:"、",privacyTextFour:"和",privacyTextFive:"并授权登录"},setSloganHidden:"true",setDialogTheme:{width:"300",height:"400",marginLeft:"0",marginTop:"0",isBottom:"false"}},widgets:{widget1:{widgetId:"customView_one",type:"TextView",left:"",top:"195",right:"",bottom:"",width:"",height:"30",textContent:"自定义控件（不销毁授权页）",textFont:"13",textColor:"#cc0000",backgroundColor:"#ffffff",isFinish:"false"},widget2:{widgetId:"customView_two",type:"ImageView",left:"",top:"230",right:"",bottom:"",width:"30",height:"30",backgroundImgPath:"static/qq.png",isFinish:"true"}}},function(t){console.log(n(JSON.stringify(t)," at pages/login/login.vue:479"))}),this.shanyan_code=1e3,this.shanyan_result="授权页配置完成";else if("ios"==o){var e=plus.screen.resolutionWidth,i=plus.screen.resolutionHeight,a=plus.screen.resolutionHeight,c=plus.screen.resolutionWidth,g=e/375;g>1&&(g=1);var r=.5*e,s=.5*i,u=.8*e,h=.8*u,y=25*g,d=60*g,f=60*g,L=0,p=-20*g,m=50*g,v=-50*g,B=20*g,C=p+.5*B*g+20*g+15*g,S=30*g,w=70*g,P=-70*g,A=40*g,x=-40*g,_=0*g,O=45*g,T=0,N=0,k=15*g,b=_-O,I=.5*a,J=.5*c,H=.8*e,R=.8*H,W=60*g,F=60*g,Y=0,z=25*g,V=-20*g,q=50*g,X=-50*g,j=20*g,D=V+.5*j*g+20*g+15*g,E=30*g,M=70*g,U=-70*g,G=40*g,K=-40*g,$=0*g,Q=45*g,Z=0,tt=0,ot=15*g,et=$-Q;this.ios_uiConfigure={clBackgroundImg:"static/eb9a0dae18491990a43fe02832d3cafa.jpg",shouldAutorotate:!0,supportedInterfaceOrientations:5,clNavigationBackgroundClear:!0,clNavigationBackBtnImage:"static/img/close-white.png",clNavBackBtnAlimentRight:!0,clLogoImage:"static/img/logo_shanyan_text.png",clLoginBtnText:"本机号一键登录",clLoginBtnTextColor:[1,1,1,1],clLoginBtnBgColor:[.2,.8,.2,1],clLoginBtnTextFont:15*g,clLoginBtnCornerRadius:10,clLoginBtnBorderWidth:.5,clLoginBtnBorderColor:[.1,.8,.1,1],clPhoneNumberFont:20*g,clAuthTypeUseWindow:!0,clAuthWindowCornerRadius:20,clAppPrivacyColor:[[.6,.6,.6,1],[0,1,0,1]],clAppPrivacyTextFont:11*g,clAppPrivacyTextAlignment:0,clAppPrivacyFirst:["测试连接A","https://www.baidu.com"],clAppPrivacySecond:["测试连接B","https://www.sina.com"],clCheckBoxVerticalAlignmentToAppPrivacyCenterY:!0,clCheckBoxSize:[30*g,30*g],clCheckBoxImageEdgeInsets:[2*g,10*g,13*g,5*g],clCheckBoxUncheckedImage:"static/img/checkBoxNor.png",clCheckBoxCheckedImage:"static/img/checkBoxSEL.png",clLoadingSize:[50,50],clLoadingTintColor:[.2,.8,.2,1],clLoadingBackgroundColor:[1,1,1,1],clLoadingCornerRadius:5,clOrientationLayOutPortrait:{clAuthWindowOrientationWidth:u,clAuthWindowOrientationHeight:h,clAuthWindowOrientationCenterX:r,clAuthWindowOrientationCenterY:s,clLayoutLogoWidth:d,clLayoutLogoHeight:f,clLayoutLogoCenterX:L,clLayoutLogoTop:y,clLayoutPhoneCenterY:p,clLayoutPhoneHeight:B,clLayoutPhoneLeft:m,clLayoutPhoneRight:v,clLayoutLoginBtnCenterY:C,clLayoutLoginBtnHeight:S,clLayoutLoginBtnLeft:w,clLayoutLoginBtnRight:P,clLayoutAppPrivacyLeft:A,clLayoutAppPrivacyRight:x,clLayoutAppPrivacyBottom:_,clLayoutAppPrivacyHeight:O,clLayoutSloganLeft:T,clLayoutSloganRight:N,clLayoutSloganHeight:k,clLayoutSloganBottom:b},clOrientationLayOutLandscape:{clAuthWindowOrientationWidth:H,clAuthWindowOrientationHeight:R,clAuthWindowOrientationCenterX:I,clAuthWindowOrientationCenterY:J,clLayoutLogoWidth:W,clLayoutLogoHeight:F,clLayoutLogoCenterX:Y,clLayoutLogoTop:z,clLayoutPhoneCenterY:V,clLayoutPhoneHeight:j,clLayoutPhoneLeft:q,clLayoutPhoneRight:X,clLayoutLoginBtnCenterY:D,clLayoutLoginBtnHeight:E,clLayoutLoginBtnLeft:M,clLayoutLoginBtnRight:U,clLayoutAppPrivacyLeft:G,clLayoutAppPrivacyRight:K,clLayoutAppPrivacyBottom:$,clLayoutAppPrivacyHeight:Q,clLayoutSloganLeft:Z,clLayoutSloganRight:tt,clLayoutSloganHeight:ot,clLayoutSloganBottom:et}},this.shanyan_code=1e3,this.shanyan_result="授权页配置完成"}},startAuthentication:function(){var o=this;t.showLoading({mask:!0}),l.startAuthentication(function(e){t.hideLoading(),o.shanyan_code=JSON.stringify(e.code),o.shanyan_result=JSON.stringify(e.result),console.log(n(JSON.stringify(e)," at pages/login/login.vue:719"))})},qulickLogin:function(){var o=this;t.showLoading({mask:!0}),setTimeout(function(){t.hideLoading()},5e3);var e=t.getSystemInfoSync().platform;if("android"==e)l.openLoginAuth(!0,function(e){t.hideLoading(),o.shanyan_code=JSON.stringify(e.code),o.shanyan_result=JSON.stringify(e.result),console.log(n(JSON.stringify(e)," at pages/login/login.vue:738"))},function(t){o.shanyan_code=JSON.stringify(t.code),o.shanyan_result=JSON.stringify(t.result),console.log(n(JSON.stringify(t)," at pages/login/login.vue:743"))});else if("ios"==e){if(null==this.ios_uiConfigure)return void t.showToast({icon:"none",title:"请先配置UI",duration:3e3});l.quickAuthLoginWithConfigure(this.ios_uiConfigure,function(e){t.hideLoading(),t.showToast({icon:"none",title:JSON.stringify(e),duration:3e3}),o.shanyan_code=JSON.stringify(e.code),o.shanyan_result=JSON.stringify(e),console.log(n(JSON.stringify(e)," at pages/login/login.vue:775"))},function(e){t.hideLoading(),null!=e.error?1011==e.code||l.finishAuthControllerCompletion(function(t){}):(l.finishAuthControllerCompletion(function(t){}),t.showToast({icon:"none",title:JSON.stringify(e),duration:3e3})),o.shanyan_code=JSON.stringify(e.code),o.shanyan_result=JSON.stringify(e),console.log(n(JSON.stringify(e)," at pages/login/login.vue:816"))})}},toMain:function(o){this.login(o),this.forcedLogin?t.reLaunch({url:"../main/main"}):t.navigateBack()}},onReady:function(){}};o.default=g}).call(this,e("6e42")["default"],e("0de9")["default"])},8409:function(t,o,e){"use strict";var n=e("2b43"),i=e.n(n);i.a},"8e25":function(t,o,e){"use strict";e.r(o);var n=e("dba8"),i=e("a5fe");for(var a in i)"default"!==a&&function(t){e.d(o,t,function(){return i[t]})}(a);e("8409");var c=e("2877"),l=Object(c["a"])(i["default"],n["a"],n["b"],!1,null,null,null);o["default"]=l.exports},a5fe:function(t,o,e){"use strict";e.r(o);var n=e("66c0"),i=e.n(n);for(var a in n)"default"!==a&&function(t){e.d(o,t,function(){return n[t]})}(a);o["default"]=i.a},dba8:function(t,o,e){"use strict";var n=function(){var t=this,o=t.$createElement;t._self._c},i=[];e.d(o,"a",function(){return n}),e.d(o,"b",function(){return i})}},[["159f","common/runtime","common/vendor"]]]);
});
